...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/ZAYURWGX6RR4TQ7FPY9LG/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/art/data
AST_DATA_PATH=/tmp/applifire/db/ZAYURWGX6RR4TQ7FPY9LG/6BE6DB6D-9D38-4A34-8DE5-68F3A79FF98C/ast/data
MYSQL=/usr/bin
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_SalesData_T.csv' into table ast_SalesData_T FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
