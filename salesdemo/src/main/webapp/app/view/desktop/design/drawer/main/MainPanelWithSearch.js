Ext.define('Salesdemo.view.desktop.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Salesdemo.view.desktop.design.drawer.main.MainPanelController','Salesdemo.view.desktop.design.drawer.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
