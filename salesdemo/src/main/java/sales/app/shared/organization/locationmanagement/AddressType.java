package sales.app.shared.organization.locationmanagement;
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.organization.locationmanagement.AddressType other = (sales.app.shared.organization.locationmanagement.AddressType) obj;
            if (addressTypeId == null) {
                return false;
