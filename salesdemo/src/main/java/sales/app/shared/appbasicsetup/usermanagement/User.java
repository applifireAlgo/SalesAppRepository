package sales.app.shared.appbasicsetup.usermanagement;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<sales.app.shared.appbasicsetup.usermanagement.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            sales.app.shared.appbasicsetup.usermanagement.User other = (sales.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
