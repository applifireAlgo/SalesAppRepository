package sales.app.server.service.organization.locationmanagement.aspect;
...
public class ServicelocationmanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
