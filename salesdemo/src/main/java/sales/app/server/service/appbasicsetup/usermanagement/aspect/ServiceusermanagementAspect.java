package sales.app.server.service.appbasicsetup.usermanagement.aspect;
...
public class ServiceusermanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.appbasicsetup.usermanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
