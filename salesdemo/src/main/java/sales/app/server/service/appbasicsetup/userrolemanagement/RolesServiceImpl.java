...
import sales.app.server.businessservice.appbasicsetup.userrolemanagement.RolesBusinessService;
...
public class RolesServiceImpl extends RolesService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<sales.app.shared.appbasicsetup.userrolemanagement.Roles> lstroles = rolesrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        sales.app.shared.appbasicsetup.userrolemanagement.Roles lstroles = rolesrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSRM224990200");
