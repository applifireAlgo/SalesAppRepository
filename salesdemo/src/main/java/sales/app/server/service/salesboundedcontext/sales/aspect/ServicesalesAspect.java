...
public class ServicesalesAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* sales.app.server.service.salesboundedcontext.sales..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
