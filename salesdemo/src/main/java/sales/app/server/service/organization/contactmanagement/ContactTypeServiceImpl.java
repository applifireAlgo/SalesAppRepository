...
import sales.app.server.repository.organization.contactmanagement.ContactTypeRepository;
...
public class ContactTypeServiceImpl extends ContactTypeService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<sales.app.shared.organization.contactmanagement.ContactType> lstcontacttype = contactTyperepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        sales.app.shared.organization.contactmanagement.ContactType lstcontacttype = contactTyperepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
