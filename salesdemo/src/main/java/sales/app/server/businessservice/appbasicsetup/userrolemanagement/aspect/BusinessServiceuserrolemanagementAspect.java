package sales.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
