package sales.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.organization.contactmanagement..*(..))")
