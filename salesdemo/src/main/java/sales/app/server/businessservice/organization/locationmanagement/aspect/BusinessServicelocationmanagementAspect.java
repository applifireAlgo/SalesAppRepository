package sales.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.organization.locationmanagement..*(..))")
