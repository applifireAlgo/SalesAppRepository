package sales.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
