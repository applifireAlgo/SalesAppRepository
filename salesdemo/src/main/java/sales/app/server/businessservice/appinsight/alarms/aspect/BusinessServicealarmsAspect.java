package sales.app.server.businessservice.appinsight.alarms.aspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* sales.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* sales.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
