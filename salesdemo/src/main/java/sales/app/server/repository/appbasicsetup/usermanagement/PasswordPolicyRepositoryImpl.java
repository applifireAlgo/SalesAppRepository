...
public class PasswordPolicyRepositoryImpl extends SearchInterfaceImpl implements PasswordPolicyRepository<PasswordPolicy> {
    ...
    public List<PasswordPolicy> save(List<PasswordPolicy> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.appbasicsetup.usermanagement.PasswordPolicy obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.appbasicsetup.usermanagement.PasswordPolicy s = emanager.find(sales.app.shared.appbasicsetup.usermanagement.PasswordPolicy.class, id);
        emanager.remove(s);
    ...
    public PasswordPolicy findById(String policyId) throws Exception {
        ...
        sales.app.shared.appbasicsetup.usermanagement.PasswordPolicy listOfPasswordPolicy = (sales.app.shared.appbasicsetup.usermanagement.PasswordPolicy) query.getSingleResult();
