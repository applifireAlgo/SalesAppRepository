...
public class GenderRepositoryImpl extends SearchInterfaceImpl implements GenderRepository<Gender> {
    ...
    public List<Gender> findAll() throws Exception {
        ...
        java.util.List<sales.app.shared.organization.contactmanagement.Gender> query = emanager.createQuery("select u from Gender u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Gender> save(List<Gender> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.organization.contactmanagement.Gender obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.organization.contactmanagement.Gender s = emanager.find(sales.app.shared.organization.contactmanagement.Gender.class, id);
        emanager.remove(s);
    ...
    public Gender findById(String genderId) throws Exception {
        ...
        sales.app.shared.organization.contactmanagement.Gender listOfGender = (sales.app.shared.organization.contactmanagement.Gender) query.getSingleResult();
