package sales.app.server.repository.organization.locationmanagement.aspect;
...
public class RepositorylocationmanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.organization.locationmanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
