package sales.app.server.repository.appinsight.health.aspect;
...
public class RepositoryhealthAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* sales.app.server.repository.appinsight.health..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.appinsight.health..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.appinsight.health..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.appinsight.health..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.appinsight.health..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* sales.app.server.repository.appinsight.health..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
