...
import sales.app.shared.organization.contactmanagement.ContactType;
...
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws Exception {
        ...
        java.util.List<sales.app.shared.organization.contactmanagement.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<ContactType> save(List<ContactType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.organization.contactmanagement.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.organization.contactmanagement.ContactType s = emanager.find(sales.app.shared.organization.contactmanagement.ContactType.class, id);
        emanager.remove(s);
    ...
    public ContactType findById(String contactTypeId) throws Exception {
        ...
        sales.app.shared.organization.contactmanagement.ContactType listOfContactType = (sales.app.shared.organization.contactmanagement.ContactType) query.getSingleResult();
