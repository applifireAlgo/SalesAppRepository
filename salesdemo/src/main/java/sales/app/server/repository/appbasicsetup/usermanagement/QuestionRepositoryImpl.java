...
public class QuestionRepositoryImpl extends SearchInterfaceImpl implements QuestionRepository<Question> {
    ...
    public List<Question> findAll() throws Exception {
        ...
        java.util.List<sales.app.shared.appbasicsetup.usermanagement.Question> query = emanager.createQuery("select u from Question u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Question> save(List<Question> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.appbasicsetup.usermanagement.Question obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.appbasicsetup.usermanagement.Question s = emanager.find(sales.app.shared.appbasicsetup.usermanagement.Question.class, id);
        emanager.remove(s);
    ...
    public Question findById(String questionId) throws Exception {
        ...
        sales.app.shared.appbasicsetup.usermanagement.Question listOfQuestion = (sales.app.shared.appbasicsetup.usermanagement.Question) query.getSingleResult();
