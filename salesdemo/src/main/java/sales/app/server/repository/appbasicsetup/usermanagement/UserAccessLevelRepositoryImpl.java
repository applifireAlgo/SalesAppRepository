...
public class UserAccessLevelRepositoryImpl extends SearchInterfaceImpl implements UserAccessLevelRepository<UserAccessLevel> {
    ...
    public List<UserAccessLevel> findAll() throws Exception {
        ...
        java.util.List<sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel> query = emanager.createQuery("select u from UserAccessLevel u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserAccessLevel> save(List<UserAccessLevel> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel s = emanager.find(sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel.class, id);
        emanager.remove(s);
    ...
    public UserAccessLevel findById(String userAccessLevelId) throws Exception {
        ...
        sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel listOfUserAccessLevel = (sales.app.shared.appbasicsetup.usermanagement.UserAccessLevel) query.getSingleResult();
