package sales.app.server.repository.appbasicsetup.userrolemanagement;
...
public class RolesRepositoryImpl extends SearchInterfaceImpl implements RolesRepository<Roles> {
    ...
    public List<Roles> findAll() throws Exception {
        ...
        java.util.List<sales.app.shared.appbasicsetup.userrolemanagement.Roles> query = emanager.createQuery("select u from Roles u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Roles> save(List<Roles> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            sales.app.shared.appbasicsetup.userrolemanagement.Roles obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        sales.app.shared.appbasicsetup.userrolemanagement.Roles s = emanager.find(sales.app.shared.appbasicsetup.userrolemanagement.Roles.class, id);
        emanager.remove(s);
    ...
    public void deleteRoleMenuBridge(List<RoleMenuBridge> rolemenubridge) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (sales.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge _rolemenubridge : rolemenubridge) {
            sales.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge s = emanager.find(sales.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge.class, _rolemenubridge.getRoleMenuMapId());
            emanager.remove(s);
        }
    }
    ...
    public Roles findById(String roleId) throws Exception {
        ...
        sales.app.shared.appbasicsetup.userrolemanagement.Roles listOfRoles = (sales.app.shared.appbasicsetup.userrolemanagement.Roles) query.getSingleResult();
