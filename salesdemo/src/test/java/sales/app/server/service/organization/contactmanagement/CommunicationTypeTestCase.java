...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupDescription("Y8hgRciUuAFw63uP7TzqHFRWR4YYuQrNxWBxDd4hmoWenxdkjD");
        communicationgroup.setCommGroupName("XqAeodGwc6SJtRlbDCOifDQpVAal6yzsHO4CVbL6SVIMvUEKiQ");
        ...
        communicationtype.setCommTypeName("t7RgOTvQltnx99W0ODQzHnimMw7cEtWCp6XkqvjkVYCEBbmoKP");
        communicationtype.setCommTypeDescription("Iuty9aaTN25xLylzj3RyYrlOgNt2u13fOMhHMtcVwIpdivQPJ9");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("uxoYsTSeXxbhBzkCyrrUVQJqkB0KeQ407lv4OWwJ2jbI7e01H7");
            communicationtype.setVersionId(1);
            communicationtype.setCommTypeDescription("xOlT2fuPbDghhKDT4jW3UqY9o1eiYS0mq0I2XzLYalkVAwO1aW");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "0cRAgIJvVf514pd3DDRG7Awl55XRvIeyHVbiEoTOvRySdaPboANIvMfxuQp2WZAlAyyGEqapVPhhBgKYqFhEjtJOOiGqK4y0C9pui6ycmx45LGrJzzHAsvNn34YJt0Kiy"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
