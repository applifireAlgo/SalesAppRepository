...
public class DistributorTestCase extends EntityTestCriteria {
    ...
    private Distributor createDistributor(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("bpt7VGrAclkfiH1NiQCiCUugSzjhmMog0hhC2dicut79fKGb80");
        ...
        distributor.setDistributorname("OTWt3Kg52OfyaNyhWJyDkbaPOGVDmqbXc6aFUpZpVUPuXdvjQj");
        distributor.setLongitude(8900.0d);
    ...
    public void test2Update() {
        try {
            ...
            distributor.setLattitude(3200.0d);
            distributor.setDistributorname("Ir8ZBdXrIQeA4uKObODI7SBnPhEdqYtOvtvDSxESjYF4pTGx7c");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "distributorname", "Memgi8qXRYCRVOnmGxzcYbn7JPAIJXYCmKKHWdKwOAssWz6i8qnnLXbV0UggTk1pb"));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "longitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "longitude", 1.0746775765229814E19d));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 5, "lattitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "lattitude", 1.1986099607660888E19d));
