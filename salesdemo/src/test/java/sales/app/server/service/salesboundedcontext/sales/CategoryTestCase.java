...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory(Boolean isSave) throws Exception {
        ...
        category.setCategoryInformation("YJzqe7926iSyey63j9C2CLmgkyOQ6hUKrFZmejYXpqNUMlLE8w");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategoryInformation("UoaLBq8MHjwBV8QS0YL6DA0Fw074UQgRgp3p7Bw1tnraPpDaKi");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "categoryInformation", "i74ud1na3BQYrBWNkkAlSkhc2FpoitbfBszuAVLmpO3rVAW2dDbN2jbwbZEBF3sTh"));
