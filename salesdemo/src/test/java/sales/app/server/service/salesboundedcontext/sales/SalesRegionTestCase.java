...
public class SalesRegionTestCase extends EntityTestCriteria {
    ...
    private SalesRegion createSalesRegion(Boolean isSave) throws Exception {
        ...
        salesregion.setRegionname("ZQLPdTNZ1Qgf0mTJiaDANKkU4xGAbjbtyBgLM0SIvFqIxsvNKB");
    ...
    public void test2Update() {
        try {
            ...
            salesregion.setRegionname("ZGuYb0O3Bgiaga6L1pfQXdDWHf4inajRFvrSmWZyiPyfNnHSet");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "regionname", "E3Brf03ox5EHu5dzGwdjVPt3Ru2vcInAxspLqq4Lg6j89H1qN4EsUIC8DVGCi0Vbd"));
