...
public class MaterialTestCase extends EntityTestCriteria {
    ...
    private Material createMaterial(Boolean isSave) throws Exception {
        ...
        brand.setBranddesc("OGfBHbWLxRDAbGAjwENh2mG6DXnop6XHlBqPgYJmrI889Gugte");
        Category category = new Category();
        category.setCategoryInformation("Dn1dTSsVTEpvmbjGeInRNTsY9N4r8ni2T1ymwg9nUQXLl5XoQ2");
        Category CategoryTest = new Category();
        if (isSave) {
            CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
        }
        brand.setBranddesc("9ywgspjhqRhTD3E1nLVVWMl0UixJjQNcK0q1ob0lNpON8ih0sp");
        ...
        material.setMaterialdesc("6NWxapeK4jeU5pYv21Vx1pNVzBie75kS1nBusnyH9opiNeiS4y");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("NpVkHeb9LcROYTBUv8VM2FFyp5Y6NDyDOz3EW0fprxW9c8AVUq");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "materialdesc", "4evHAmZhmq4lN2kV9qSatoAbP6GhyuKNnSnO3cxSMAWV2xtNvlvJ0wMAF0MdtTrFz"));
