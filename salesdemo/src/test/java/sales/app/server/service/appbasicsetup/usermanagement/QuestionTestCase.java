...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("oQTLYJoWrV");
        question.setQuestion("VhaK1g2NUkwEgyRGvNAw1nsUEgZ1FZniD70Myl3knOC9u4Fhdt");
        question.setQuestionIcon("hoBsgAQiZ4p1uAbwBJPg0HII41MPy7GJwcIIpgIttwzLlF5CMH");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("wvNjvPRuJH");
            question.setQuestion("FP0yTWXaYjLLNdTrlkaLQXDWPCygf2uKo2aUgmIGSYJUF6qWXL");
            question.setQuestionIcon("tXkckhPnndK9qgTVYIaqVyqE4YFnF9pxYXM3iHmfow1TqhE3Yh");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 14));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "6StpoOEdT1x7G2cgND5i3Z32RVvfguayG44lUoEn7UIrKYaOCpwIM3lEUjp6cWVhk"));
