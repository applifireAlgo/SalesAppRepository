...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainIcon("HU2z9RShr9SA7EcRmIM3uVnk7c5QB1Dt2ovUOZCij7EXQzINDl");
        useraccessdomain.setDomainDescription("tuZNznTlqjq40yIoHUGFqY9NT3hQKV7hxeOTvbdRS1RVKEbacf");
        useraccessdomain.setDomainHelp("npxVNflqqk7ClONnBHFpEDYPmOxBRO5vnoAfG9qrOB7WXHIT20");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("q5MsQ0ynYD4nQqNUiM6Wfv7H5xoYc1MOxWKEje74WrGxLGfs09");
        ...
        useraccesslevel.setLevelDescription("2aYyJqkqBOtzB4DQdder7ndkduwpdUG2vr7Am5TSI2yufyFXzU");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("2NDpkajfeOnZNmEa2SPzHwunuy1HO536sfNIQKY1Fgw3UAYXh0");
        useraccesslevel.setLevelName("KmwQuhH7XlvWwgKQnlEaSUvU2AwCDVrgv3BWy7QAtaES2FhO2A");
        useraccesslevel.setLevelIcon("VoqM2DvayhLdon9cCdXAXSv6qicThrC4KYNygICHvKNywow3Fk");
        ...
        user.setPasswordExpiryDate(new java.sql.Timestamp(1464159399953l));
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setSessionTimeout(919);
        user.setGenTempOneTimePassword(1);
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1464159400054l));
        user.setUserAccessCode(5613);
        user.setAllowMultipleLogin(1);
        user.setIsLocked(1);
        user.setPasswordAlgo("glpJOh4xxOO35R8EPUmR11nNZSPLpGUEeruBFDhKtNyJxxhUNU");
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("F37Oj0JrfySRxlk1ZV1W6NHLqGb0Oif5JUQUcmBsjMh2jTyIFH");
        Question question = new Question();
        question.setQuestionDetails("1CPWXaZ8hU");
        question.setQuestion("dNO81BlJrsAoGHilvNk8dgcsxLV4vJ1ygFIlKf2hc1g622xTp8");
        question.setQuestionIcon("wXTZx70lXRsITT8IAOSxzIUfFJqcmx5kkZPEh0RSu9TTiApXcI");
        ...
        passrecovery.setAnswer("aqfim3WcjkA2SLXKHPdAyiRQMPCLaPwU2vdEHp4619Zu1fPa91");
        ...
        userdata.setPassword("ykmbQWmZQLV4jgz4QOnqVJw2qY80ARKDUiCyPaJDmvoSqzzMWv");
        userdata.setOneTimePassword("CdyzpHDvCpu84tamUfaWxBGRI7nySxre");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464159400282l));
        userdata.setOneTimePasswordExpiry(5);
        userdata.setPassword("77njR4xOto3fsVWcnqhbf9OWvyvGdwwXcJlHydWue4UuslKpc6");
        userdata.setOneTimePassword("D2heZWcONaeoR1CYyoIGw18PscZjLAyk");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464159400297l));
        userdata.setUser(user);
        userdata.setLast5Passwords("vmQ1wSAR5vxaWLSA3YUT72JCCdbGoNCJNhzynIwQ0aQdvzbfN5");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 72070));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "o8czuTciuZiK0FWDaL5ybkbKxp2VSNq2ys1Ha2nWZsLVj0HX5RtcbNUdKG41tgvzs"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4471));
