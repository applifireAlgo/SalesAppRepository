...
public class CurrentMonthTestCase extends EntityTestCriteria {
    ...
    private CurrentMonth createCurrentMonth(Boolean isSave) throws Exception {
        ...
        currentmonth.setMonthname("9Rvno65McMDF80MSKsaXDpHp2PqxdfdIOYlQqJ6AuW75oAyvoE");
    ...
    public void test2Update() {
        try {
            ...
            currentmonth.setMonthname("oWA7GDsPnXcdgo2M2mkXyb4lK6m7Iy34bDSy1eykUfJOQZ3Ads");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "monthname", "I3ZthmxVzFhVQXKVVkK8IM4SSdJ7eH8WepZE0q3LUZfaI1BfPjl8scr0YEz7f0IOQ"));
