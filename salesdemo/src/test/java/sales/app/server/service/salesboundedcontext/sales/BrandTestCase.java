...
public class BrandTestCase extends EntityTestCriteria {
    ...
    private Brand createBrand(Boolean isSave) throws Exception {
        ...
        category.setCategoryInformation("3Xu4zcXXb8jeAe5zntDJCaB2ja9iuF7pD9uYkxIOzfb0CPmVZI");
        ...
        brand.setBranddesc("H9Txx42daEJZgL7Y1GC5EKXPy5Qpu8y5BFcuvzhggWJm4CaATV");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("gZjCyslicTMJLXJRNsV74fceegF6IUcFNvPXrfrinFcaZgDUwX");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "branddesc", "3isJYGEB690xutIdyBNvvUJIpjY9ka5HmO6ytsgJcRCbVnYGPLxTl98mUzuQYgIlB"));
