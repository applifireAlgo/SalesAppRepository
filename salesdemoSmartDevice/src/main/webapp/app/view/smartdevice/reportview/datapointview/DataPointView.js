Ext.define('Salesdemo.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Salesdemo.view.smartdevice.reportview.datapointview.DataPointViewController'],
