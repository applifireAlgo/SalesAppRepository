Ext.define('Salesdemo.salesdemo.smartdevice.sales.controller.salesboundedcontext.sales.SalesDataMainController', {
     ...
     reatilercodeLoad: function() {
          ...
          Ext.Ajax.request({
               url: AppRestUrl + 'secure/Retailer/findAll',
               method: 'GET',
               sender: scope,
               jsonData: {},
     ...
     channelIdLoad: function() {
          var scope = this.getView();
          Ext.Ajax.request({
               url: AppRestUrl + 'secure/Channel/findAll',
               method: 'GET',
               sender: scope,
               jsonData: {},
               success: function(response, scope) {
     ...
     onBrandcodeChangeMaterialcode: function(me, newValue, oldValue, eOpts) {
          ...
          Ext.Ajax.request({
               async: false,
               url: AppRestUrl + 'secure/Material/findByBrandcode',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
     ...
     onCategoryIdChangeBrandcode: function(me, newValue, oldValue, eOpts) {
          ...
          Ext.Ajax.request({
               async: false,
               url: AppRestUrl + 'secure/Brand/findByCategoryId',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#SalesDataTree');
          treePanel.collapse();
          var formPanel = this.getView().up().down('#SalesData');
     ...
     loadData: function(responseData) {
          this.view.down('#SalesData').getViewModel().setData(responseData.response.data);
     },
